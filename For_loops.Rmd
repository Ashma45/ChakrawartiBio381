...
read_data <- function(z=NULL) {
  if (is.null(z))  {
                  Cows <- round(rnorm(mean=40,n=200,sd=10),2)
                  Humans <- round(rnorm(mean=44,n=200,sd=7),2)
...
#### The p-value of my original dataset falls within the range of p-value of randomization test. Even though I am accepting the null hypothesis ,this suggests that the result obtained is not by chance. 